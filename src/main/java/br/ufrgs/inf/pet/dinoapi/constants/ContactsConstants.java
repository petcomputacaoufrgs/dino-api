...
public final class ContactsConstants {
    ...
    public final static String NAME_MAX_MESSAGE = "name should not be more than 100.";
    ...
    public final static String DESCRIPTION_MAX_MESSAGE = "name should not be more than 100.";

    public final static int COLOR_MAX = 10;
    public final static String COLOR_MAX_MESSAGE = "color should not be more than 10.";
