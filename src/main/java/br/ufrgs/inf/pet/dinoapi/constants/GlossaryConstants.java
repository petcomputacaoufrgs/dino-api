...
public final class GlossaryConstants {
    ...
    public final static String TITLE_MESSAGE = "title should be between 1 and MAX.";
    ...
    public final static String FULLTEXT_MESSAGE = "fullText should be between 1 and MAX.";
