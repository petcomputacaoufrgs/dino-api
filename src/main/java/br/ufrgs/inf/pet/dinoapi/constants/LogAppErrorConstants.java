...
public final class LogAppErrorConstants {
    ...
    public final static int TITLE_MAX = 10000;
    public final static String TITLE_MESSAGE = "title should not be more than 10000.";


    public final static int FILE_MAX = 500;
    public final static String FILE_MESSAGE = "file should not be more than 500.";

    public final static int ERROR_MAX = 20000;
    public final static String ERROR_MESSAGE = "error should not be more than 20000.";
    public final static String ERROR_NULL_MESSAGE = "error should not be null.";
