...
public final class NoteConstants {
        ...
        public final static int QUESTION_MAX = 500;
        ...
        public final static String ANSWER_MESSAGE = "answer should be between 0 and MAX.";

        public final static int TAG_NAME_MAX = 100;
