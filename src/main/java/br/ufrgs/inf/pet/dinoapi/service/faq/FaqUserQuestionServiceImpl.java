...
public class FaqUserQuestionServiceImpl extends SynchronizableServiceImpl<FaqUserQuestion, Long, Integer, FaqUserQuestionDataModel, FaqUserQuestionRepository>  {
    ...
    @Autowired
    public FaqUserQuestionServiceImpl(FaqUserQuestionRepository repository, AuthServiceImpl authService, FaqServiceImpl faqService, ClockServiceImpl clockService,
